...
>additional-url="https://experienceleague.adobe.com/docs/experience-manager-65/developing/introduction/dev-guidelines-bestpractices.html" text="Desenvolvimento do AEM - diretrizes e práticas recomendadas"
...
* `unsupported.asset.api`: O uso de APIs do Asset Manager não compatíveis no código do aplicativo.
...
* `unsupported.asset.api`
   * As APIs a seguir do AssetManager são marcadas como não compatíveis em AEM as a Cloud Service.
...
>additional-url="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/maintenance.html" text="Tarefas de manutenção no AEM as a Cloud Service"
...
* `unsupported.asset.api`
   * Em vez de usar APIs não compatíveis do Asset Manager, use [aem-upload](https://github.com/adobe/aem-upload).
