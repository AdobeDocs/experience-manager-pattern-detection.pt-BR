...
Gerenciador multisite (MSM)

## Fundo {#background}

>[!CONTEXTUALHELP]
>id="aemcloud_bpa_msm_overview"
>title="Gerenciador multisite (MSM)"
...
`MSM` identifica informações gerais sobre o recurso do Gerenciador multisite do AEM. Essa informação é fornecida para ajudar a caracterizar o sistema.

Os subtipos são usados para identificar diferentes tipos de informações:

* `cq.livesyncconfig.found`: detecção de um nó `/jcr:content/cq:LiveSyncConfig` no conteúdo adicionado ao AEM, o que é uma indicação do uso do Gerenciador multisite.
