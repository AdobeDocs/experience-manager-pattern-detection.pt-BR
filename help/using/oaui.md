...
>abstract="O código OAUI identifica o padrão em que há pelo menos um usuário configurado relacionado ao OAuth que requer a migração correta. O OAuth é configurado para usuários quando há um nó secundário chamado OAuth diretamente em um nó rep:AuthorizableId, na forma de /home/user-path/user-node/oauth"
