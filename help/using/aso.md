...
* Os ativos não processados devem ser processados, e a propriedade `dam:assetState` no nó `jcr:content` do ativo deve ser definida como “processada”. Ou remova esses ativos do conjunto de migração antes de migrar para o AEMaaCS.
